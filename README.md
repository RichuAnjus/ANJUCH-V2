...
4. You will have to fork this git to deploy via Heroku.
 ...
 Click [FORK]https://github.com/RichuAnjus/ANJUCH-V2fork)

5. Now https://heroku.com/deploy?template=https://github.com/RichuAnjus/ANJUCH-V2 copy this url and change Chunkindepadayali with your github username and click go<br>
